...
def test_cli_build_model_outputs_projects_existing_bundle_without_recomputing_analysis(
    ...
    assert "01_option_required_paths/required_path_execution_realism.csv" in payload["promoted_files"]
    assert "01_option_required_paths/required_path_candidate_ranking.csv" in payload["promoted_files"]
    assert "01_option_required_paths/required_path_historical_realism.csv" in payload["promoted_files"]
