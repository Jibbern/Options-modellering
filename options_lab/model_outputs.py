    ...
    *,
    ...
    inspect_items = bullets_for_available(
        [
            ...
            ("00_core_view/single_option_decision.md", "one selected call tested directly against buying stock across representative path families"),
            ("00_core_view/single_option_decision_view.png", "hero view answering what stock paths make the selected option worth buying instead of stock"),
