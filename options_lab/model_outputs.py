    ...
    *,
    ...
    inspect_items = bullets_for_available(
        [
            ...
            ("00_core_view/single_option_required_path_to_beat_stock_1_5x.csv", "minimum stock path required for the selected call to beat stock by the configured threshold"),
            ("00_core_view/single_option_required_path_to_beat_stock_2_0x.csv", "strong-edge stock path required for the selected call to beat stock by the configured higher threshold"),
            ...
            ("00_core_view/single_option_edge_gap_by_path_family.csv", "path-family gaps showing whether misses are too low, too late, or both"),
