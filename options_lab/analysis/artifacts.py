    ...
    summary_lines = [
        ...
        *_markdown_table(
            [
                ...
                (
                    "How To Read It",
                    "These are deliberate scenario templates, not simulation picks. Start here by choosing which stock-path shape best matches the thesis you actually want to test.",
                ),
            ]
        ),
        "",
        ...
        [
            ...
            *_markdown_table(
                [
                    ...
                    ("`stock_path_gallery.png`", "Start by choosing the stock-path shape you actually want to think with. These are named scenario templates, not representative simulation picks."),
