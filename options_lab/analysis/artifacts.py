...
TABLE_COLUMN_ORDERS: dict[str, list[str]] = {
    ...
    "required_path_execution_realism.csv": [
        ...
        "realistic_entry_per_contract",
        "conservative_entry_per_share",
        "conservative_entry_per_contract",
        "expected_slippage_per_share",
        "expected_slippage_pct_of_mid",
        "exit_liquidity_risk",
        "stale_quote_flag",
        "wide_spread_flag",
        "zero_volume_flag",
        "zero_open_interest_flag",
        "execution_penalty_score",
        "execution_verdict",
        "concise_explanation",
    ],
    "required_path_candidate_ranking.csv": [
        ...
        "required_move_1_5x",
        "required_move_2_0x",
        "best_path_family_1_5x",
        "best_path_family_2_0x",
        "realism_bucket_1_5x",
        "realism_bucket_2_0x",
        "required_path_score",
        "liquidity_bucket",
    ...
    "required_path_historical_realism.csv": [
        ...
        "historical_forward_return_p50",
        "historical_forward_return_p75",
        "historical_forward_return_p90",
        "historical_forward_return_p95",
        "historical_forward_return_p99",
    ...
    "required_paths_by_option.csv": [
        ...
        "stock_price",
        "option_value",
        "modeled_option_value",
        "return_basis_option_value",
        "option_return_pct",
        "stock_return_pct",
    ...
    "single_option_required_path_to_beat_stock_1_5x.csv": [
        ...
        "return_pct",
        "iv_shift_points",
        "minimum_stock_profit_floor",
        "required_option_profit_loss",
        "estimated_option_profit_loss",
        "stock_profit_loss_at_required_edge",
        "edge_gap_to_threshold",
        "status",
        "is_required_edge_solved",
    ],
    ...
    "single_option_closest_representative_path_to_edge.csv": [
        ...
        "extra_stock_move_needed_pct_1_5x",
        "earlier_timing_needed",
        "iv_support_needed",
        "entry_discount_needed",
        "edge_failure_driver",
        "meaningful_stock_profit_for_edge",
        "edge_gap_to_1_5x_dollars",
        "edge_gap_to_2_0x_dollars",
...
def _write_contract_selection_bundle(
    ...
    artifact_frames = {
        ...
        "required_path_execution_realism.csv": result.required_path_execution_realism,
        "required_path_historical_realism.csv": result.required_path_historical_realism,
        "required_path_candidate_ranking.csv": result.required_path_candidate_ranking,
        ...
        "single_option_required_path_to_beat_stock_1_5x.csv": result.single_option_required_path_to_beat_stock_1_5x,
        "single_option_required_path_to_beat_stock_2_0x.csv": result.single_option_required_path_to_beat_stock_2_0x,
        "single_option_closest_representative_path_to_edge.csv": result.single_option_closest_representative_path_to_edge,
        "single_option_edge_gap_by_path_family.csv": result.single_option_edge_gap_by_path_family,
    ...
    if not result.single_option_decision_summary.empty:
        _track_chart(
            ...
            plot_single_option_decision_view(
                ...
                required_edge_paths=pd.concat(
                    [
                        result.single_option_required_path_to_beat_stock_1_5x,
                        result.single_option_required_path_to_beat_stock_2_0x,
                    ],
                    ignore_index=True,
                ),
                edge_gap_by_path_family=result.single_option_edge_gap_by_path_family,
                closest_representative_path_to_edge=result.single_option_closest_representative_path_to_edge,
    ...
    summary_lines = [
        ...
        *_markdown_table(
            [
                ...
                ("Required Path Candidate Ranking", "tables/required_path_candidate_ranking.csv"),
                ...
                ("Required Path Execution Realism", "tables/required_path_execution_realism.csv"),
                ("Required Path Historical Realism", "tables/required_path_historical_realism.csv"),
        ...
        *_markdown_table(
            [
                ...
                ("Required 1.5x Edge Path", "tables/single_option_required_path_to_beat_stock_1_5x.csv"),
                ("Required 2.0x Edge Path", "tables/single_option_required_path_to_beat_stock_2_0x.csv"),
                ("Closest Path To Edge", "tables/single_option_closest_representative_path_to_edge.csv"),
                ("Edge Gap By Path Family", "tables/single_option_edge_gap_by_path_family.csv"),
                ...
                (
                    "How To Read It",
                    "This view asks what stock path is required before one selected call beats buying stock. Representative paths are muted; required-edge paths are frozen in analysis, and IV/entry price are isolated below.",
                ),
            ]
        ),
        "",
        ...
        [
            ...
            *_markdown_table(
                [
                    ...
                    ("`single_option_required_path_to_beat_stock_1_5x.csv`", "Required stock path for the selected option to beat long stock by the configured minimum edge after stock P/L clears the meaningful bullish floor."),
                    ("`single_option_edge_gap_by_path_family.csv`", "Shows whether each selected path misses because the stock path is too low, timing is too late, IV support is missing, or entry premium is too high."),
