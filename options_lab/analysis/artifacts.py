        ...
        [
            ...
            *_markdown_table(
                [
                    ...
                    ("`single_option_required_path_to_beat_stock_1_5x.csv`", "Required stock path for the selected option to beat long stock by the configured minimum edge."),
                    ("`single_option_edge_gap_by_path_family.csv`", "Shows whether each selected path misses because the stock path is too low, too late, or both."),
